...
RECOVERY_TS_MODULE:
	mkdir -p $(KERNEL_OUT)/../../recovery/root/vendor/firmware
	cp $(KERNEL_OUT)/drivers/input/touchscreen/atmel_mxt_ts.ko $(KERNEL_OUT)/../../recovery/root/vendor/firmware

TARGET_KERNEL_MODULES += SGX_MODULES RECOVERY_TS_MODULE
